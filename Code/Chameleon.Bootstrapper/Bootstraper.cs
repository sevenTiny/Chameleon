            ...
            .AddJwtBearer(options =>
            {
                options.Events = new JwtBearerEvents()
                {
                    ...
                    OnChallenge = context =>
                    {
                        ...
                        //如果token验证失败，则跳转登陆地址
                        context.Response.Redirect(string.Concat(AccountConst.AccountSignInAndRedirectUrl, context.Request.IsHttps ? "https://" : "http://", context.Request.Host, context.Request.Path));
