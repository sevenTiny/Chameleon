...
namespace Chameleon.Application
{
    public interface IDataAccessApp
    {
        ...
        /// <returns></returns>
        object GetDynamicScriptDataSourceResult(InterfaceSetting interfaceSetting, object[] parameters);
        /// <summary>
        /// 获取json数据源的json脚本
        /// </summary>
        /// <param name="interfaceSetting"></param>
    ...
    public class DataAccessApp : IDataAccessApp
    {
        ...
        public object GetDynamicScriptDataSourceResult(InterfaceSetting interfaceSetting, object[] parameters)
        {
            var script = _triggerScriptRepository.GetById(interfaceSetting.DataSousrceId);

            var result = _triggerScriptService.ExecuteTriggerScript<object>(script, parameters);
